...
public class Instrucoes {
	...
	/**
	 * Instruções iniciais de como utilizar o jogo 
	 */
	public void instrucoesIniciais() {
		System.out.println(
				"----------------------------- INSTRUCOES INICIAIS -------------------------------------------");
		System.out.println("1. JOGAR - Sera apresentado para você uma palavra em inglês e você terá que acertar!");
		System.out.println("2. ADICIONAR - Adiciona dados ao banco de dados");
		System.out.println("3. VIZUALIZAR - Visualizar algumas predefinições de dados do banco de dados");
		System.out.println("4. ATUALIZAR - Altera os dados do banco de dados");
		System.out.println("5. EXCLUIR - Exclui dados do banco de dados");
		System.out.println("6. SAIR - Fechara o sistema");
		System.out.println(
				"-------------------------------------------------------------------------------------------\n");
	}
